Creator	"yFiles"
	...
	node
		[
			id 14378
			label "iVar2 = FUN_0044d040((void **)(in_EAX + 6),0x10000)"
			graphics
			[
				w 371.5
				h 20
	...
	node
		[
			id 14379
			label "iVar2 = (*(code *)in_EAX[0xb0])(iVar2,1,0x10000,*in_EAX)"
			graphics
			[
				w 404
				h 20
	...
	node
		[
			id 14381
			label "FUN_0044d0c0((int)(in_EAX + 6),iVar2)"
			graphics
			[
				w 280.5
				h 20
	...
	node
		[
			id 28522
			label "(iVar2 == 0) &amp;&amp; (piVar1 = _errno(), *piVar1 != 0)"
			graphics
			[
				w 508.5
				h 40

Creator	"yFiles"
	...
	node
		[
			id 5732
			label "uVar1 = FUN_0043d1c0(unaff_ESI,&amp;local_c,&amp;local_8)"
			graphics
			[
				w 358.5
				h 20
	...
	node
		[
			id 5733
			label "(uVar1 != 0) &amp;&amp; ((local_8 == in_EAX || (*(char *)(local_8 + unaff_ESI) == '\0')))"
			graphics
			[
				w 716.5
				h 40

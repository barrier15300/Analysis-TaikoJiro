Creator	"yFiles"
	...
	node
		[
			id	85380
			label	"    float10 __cdecl FUN_0045d540(float param_1)"
			graphics
			[
				w 381
				h 45
	...
	node
		[
			id 26329
			label "uVar1 = (uint)ROUND(param_1 * -8.0 - 0.5)"
			graphics
			[
				w 306.5
				h 20
	...
	node
		[
			id 26334
			label "return (float10)(*(float *)(&amp;DAT_0047a8b8 + (uVar1 &amp; 0x1f) * 4) *

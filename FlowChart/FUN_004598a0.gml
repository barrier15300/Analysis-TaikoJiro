Creator	"yFiles"
	...
	node
		[
			id	83241
			label	"    void __cdecl FUN_004598a0(void *param_1)"
			graphics
			[
				w 360
				h 45
	...
	node
		[
			id 24194
			label "*(int *)(*(int *)((int)param_1 + 0x14) + iVar1 * 4) != 0"
			graphics
			[
				w 554
				h 40
	...
	node
		[
			id 24195
			label "free(*(void **)(*(int *)((int)param_1 + 0x14) + iVar1 * 4))"
			graphics
			[
				w 423.5
				h 20
	...
	node
		[
			id 24197
			label "while (iVar1 < *(int *)((int)param_1 + 4))"
			graphics
			[
				w 313
				h 20
	...
	node
		[
			id 24202
			label "free(*(void **)(*(int *)((int)param_1 + 0x1c) + iVar1 * 4))"
			graphics
			[
				w 423.5
				h 20
	...
	node
		[
			id 24204
			label "while (iVar1 < *(int *)((int)param_1 + 0x18))"
			graphics
			[
				w 332.5
				h 20
	...
	node
		[
			id 29297
			label "free(*(void **)((int)param_1 + 0x1c))"
			graphics
			[
				w 280.5
				h 20

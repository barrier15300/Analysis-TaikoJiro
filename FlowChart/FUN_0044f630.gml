Creator	"yFiles"
	...
	node
		[
			id	76665
			label	"    uint __cdecl FUN_0044f630(int *param_1,int param_2)"
			graphics
			[
				w 437
				h 45
 ...
 iVar1 != iVar2 * 8 &amp;&amp; SBORROW4(iVar1,iVar2 * 8) == iVar1 + iVar2 * -8 < 0)"
	...
	node
		[
			id 17626
			label "uVar6 = (uint)(*pbVar4 >> (*(byte *)(param_1 + 1) &amp; 0x1f))"
			graphics
			[
				w 417
				h 20
 ...
 (uVar6 = uVar6 | (uint)pbVar4[3] << (0x18U - cVar5 &amp; 0x1f), 0x20 < iVar7)))) &amp;&amp; (iVar3 != 0)"
	...
	node
		[
			id 17628
			label "uVar6 = uVar6 | (uint)pbVar4[4] << (0x20U - cVar5 &amp; 0x1f)"
			graphics
			[
				w 410.5
				h 20
	...
	node
		[
			id 28819
			label "return uVar6 &amp; *(uint *)(&amp;DAT_0045f810 + param_2 * 4)"
			graphics
			[
				w 384.5
				h 20

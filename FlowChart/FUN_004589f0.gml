Creator	"yFiles"
	...
	node
		[
			id	82358
			label	"    float10 FUN_004589f0(void)"
			graphics
			[
				w 262
				h 45
	...
	node
		[
			id 23307
			label "return (float10)((float)(*in_EAX &amp; 0x7fffffff) * 7.177114e-07 - 764.6162)"
			graphics
			[
				w 514.5
				h 20
	...
	node
		[
			id 52832
			label "WARNING: Removing unreachable block (ram,0x00458a09)"
			graphics
			[
				w 322.4
				h 15

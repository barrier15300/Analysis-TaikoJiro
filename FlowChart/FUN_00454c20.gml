...
FUN_00454c20(int *param_1,int param_2,int param_3,int param_4,int *param_5,int param_6)"
	...
	node
		[
			id 20942
			label "while( iVar4 < (param_6 + param_3) / param_4 )"
			graphics
			[
				w 339
				h 20
	...
	node
		[
			id 20943
			label "uVar5 = FUN_00454770((int)param_1,param_5)"
			graphics
			[
				w 313
				h 20
	...
	node
		[
			id 20951
			label "iVar3 = *(int *)(param_2 + iVar7 * 4)"
			graphics
			[
				w 280.5
				h 20

Creator	"yFiles"
	...
	node
		[
			id	85911
			label	"    PIMAGE_SECTION_HEADER __cdecl __FindPESection(PBYTE pImageBase,DWORD_PTR rva)"
			graphics
			[
				w 619
				h 45
	...
	node
		[
			id 26860
			label "PIMAGE_SECTION_HEADER p_Var2"
			graphics
			[
				w 222
				h 20
	...
	node
		[
			id 26862
			label "iVar1 = *(int *)(pImageBase + 0x3c)"
			graphics
			[
				w 267.5
				h 20
	...
	node
		[
			id 26864
			label "p_Var2 = (PIMAGE_SECTION_HEADER)
(pImageBase + *(ushort *)(pImageBase + iVar1 + 0x14) + 0x18 + iVar1)"
	...
	node
		[
			id 26865
			label "*(ushort *)(pImageBase + iVar1 + 6) != 0"
			graphics
			[
				w 450
				h 40
	...
	node
		[
			id 26867
			label "(p_Var2->VirtualAddress <= rva) &amp;&amp;
 (rva < (p_Var2->Misc).PhysicalAddress + p_Var2->VirtualAddress)"
	...
	node
		[
			id 26871
			label "while (uVar3 < *(ushort *)(pImageBase + iVar1 + 6))"
			graphics
			[
				w 371.5
				h 20
	...
	node
		[
			id 29519
			label "return (PIMAGE_SECTION_HEADER)0x0"
			graphics
			[
				w 254.5
				h 20

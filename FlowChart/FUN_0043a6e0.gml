Creator	"yFiles"
	...
	node
		[
			id 4105
			label "BVar2 = PeekMessageA(&amp;local_24,(HWND)0x0,0,0,1)"
			graphics
			[
				w 345.5
				h 20
	...
	node
		[
			id 4107
			label "TranslateMessage(&amp;local_24)"
			graphics
			[
				w 215.5
				h 20
	...
	node
		[
			id 4108
			label "DispatchMessageA(&amp;local_24)"
			graphics
			[
				w 215.5
				h 20

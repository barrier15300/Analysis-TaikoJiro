Creator	"yFiles"
	...
	node
		[
			id	78643
			label	"    uint __cdecl _PtFuncCompare_00452d10(float **param_1,float **param_2)"
			graphics
			[
				w 563
				h 45
	...
	node
		[
			id 19592
			label "uVar1 = (uint)(ABS(**param_1) < ABS(**param_2))"
			graphics
			[
				w 345.5
				h 20
	...
	node
		[
			id 49117
			label "_PtFuncCompare parameter of qsort"
			graphics
			[
				w 204.6
				h 15

Creator	"yFiles"
	...
	node
		[
			id	79054
			label	"    float10 __cdecl FUN_00453810(uint param_1)"
			graphics
			[
				w 374
				h 45
	...
	node
		[
			id 20003
			label "dVar1 = (double)(param_1 &amp; 0x1fffff)"
			graphics
			[
				w 274
				h 20
	...
	node
		[
			id 29032
			label "dVar1 = ldexp(dVar1,((int)param_1 >> 0x15 &amp; 0x3ffU) - 0x314)"
			graphics
			[
				w 430
				h 20
	...
	node
		[
			id 20007
			label "return (float10)(float)dVar1"
			graphics
			[
				w 222
				h 20

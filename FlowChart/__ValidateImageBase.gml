Creator	"yFiles"
	...
	node
		[
			id	85906
			label	"    BOOL __cdecl __ValidateImageBase(PBYTE pImageBase)"
			graphics
			[
				w 430
				h 45
 ...
 (*(int *)(pImageBase + *(int *)(pImageBase + 0x3c)) == 0x4550)"
	...
	node
		[
			id 26855
			label "return (uint)(*(short *)((int)(pImageBase + *(int *)(pImageBase + 0x3c)) + 0x18) == 0x10b)"
			graphics
			[
				w 625
				h 20

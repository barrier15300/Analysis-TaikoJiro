Creator	"yFiles"
	...
	node
		[
			id	63342
			label	"    void __cdecl FUN_0043ab00(int param_1)"
			graphics
			[
				w 346
				h 45
	...
	node
		[
			id 4302
			label "pcVar2 != unaff_EBX + 1 &amp;&amp; -1 < (int)pcVar2 - (int)(unaff_EBX + 1)"
			graphics
			[
				w 619
				h 40
	...
	node
		[
			id 27435
			label "pcVar2[param_1 - (int)unaff_EBX] = cVar1"
			graphics
			[
				w 300
				h 20
	...
	node
		[
			id 4317
			label "while (iVar5 < (int)pcVar4 - (int)(unaff_EBX + 1))"
			graphics
			[
				w 365
				h 20

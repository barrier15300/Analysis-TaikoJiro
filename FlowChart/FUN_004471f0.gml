Creator	"yFiles"
	...
	node
		[
			id	71166
			label	"    void __fastcall FUN_004471f0(int param_1,int param_2)"
			graphics
			[
				w 451
				h 45
	...
	node
		[
			id 12116
			label "0x2540be30 < param_2 - 0x10U"
			graphics
			[
				w 372
				h 40
	...
	node
		[
			id 12117
			label "FUN_0043df90(&quot;Out of range gamma value ignored&quot;)"
			graphics
			[
				w 352
				h 20
	...
	node
		[
			id 12119
			label "*(uint *)(param_1 + 8) = *(uint *)(param_1 + 8) | 1"
			graphics
			[
				w 371.5
				h 20
	...
	node
		[
			id 12120
			label "*(int *)(param_1 + 0x28) = param_2"
			graphics
			[
				w 261
				h 20

Creator	"yFiles"
	...
	node
		[
			id	85850
			label	"    long __CxxUnhandledExceptionFilter(_EXCEPTION_POINTERS *param_1)"
			graphics
			[
				w 528
				h 45
	...
	node
		[
			id 26798
			label "PEXCEPTION_RECORD pEVar1"
			graphics
			[
				w 196
				h 20
	...
	node
		[
			id 26800
			label "pEVar1 = param_1->ExceptionRecord"
			graphics
			[
				w 254.5
				h 20
	...
	node
		[
			id 26801
			label "((pEVar1->ExceptionCode == 0xe06d7363) &amp;&amp; (pEVar1->NumberParameters == 3)) &amp;&amp;

Creator	"yFiles"
	...
	node
		[
			id	85736
			label	"    void __alloca_probe(void)"
			graphics
			[
				w 255
				h 45
	...
	node
		[
			id 26689
			label "puVar2 = (undefined4 *)((int)&amp;stack0x00000000 - (int)in_EAX &amp; ~-(uint)(&amp;stack0x00000000 < in_EAX))"
			graphics
			[
				w 677
				h 20
	...
	node
		[
			id 26690
			label "for( puVar1 = (undefined4 *)((uint)auStack_4 &amp; 0xfffff000); puVar2 < puVar1;
 puVar1 = puVar1 + -0x400 )"
			graphics
			[
				w 534

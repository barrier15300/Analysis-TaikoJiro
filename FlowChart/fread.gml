Creator	"yFiles"
	...
	node
		[
			id	85458
			label	"    size_t __cdecl fread(void *_DstBuf,size_t _ElementSize,size_t _Count,FILE *_File)"
			graphics
			[
				w 647
				h 45
	...
	node
		[
			id 26407
			label "sVar1 = fread(_DstBuf,_ElementSize,_Count,_File)"
			graphics
			[
				w 352
				h 20
	...
	node
		[
			id 55934
			label "WARNING: Could not recover jumptable at 0x0045d764. Too many branches 
